    ...
    <div>
      <Toolbar>
        <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
          ...
          />
          <Box>
            <Typography variant="h6" noWrap component="div" sx={{ fontWeight: 600, color: '#1976d2' }}>
              VIT-AP
            </Typography>
      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1 }}>
            {menuItems.find(item => item.path === location.pathname)?.text || 'VIT-AP Management System'}
          </Typography>
          <IconButton
            size="large"
